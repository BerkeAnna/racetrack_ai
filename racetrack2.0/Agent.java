...
public class Agent extends RaceTrackPlayer {
    ...
    /**
     * KiszamĂ­tja a kovetkezo lepest
     * @param timeBudget
    ...
    private class Node {
        ...
        /**
         * Megtett ut (g) Ă©s celpontig vezeto ut (h) koltsegenek osszegenek kiszamitasa
         * @return f = g + h
         */
        int f() {
            return g + h;
         ...
         * @param objekt
         * @return osszehasonlĂ­tja a ket Node objekt i Ă©s j koordinatait,
         *  ellenorzi, hogy a parameterben kapott object nem null Ă©s azonos osztalyu-e, mint a Node,
         *  az object onmagĂˇval egyezik-e
         */
        @Override
